...
const MusicPlayer = ({ 
  ...
  return (
    <div className="w-full max-w-md bg-[#1b1b32] border-3 border-[#3b3b4f]">
      <div className="flex justify-between items-center px-2 h-8 bg-[#3b3b4f]">
      ...
      <div className="flex bg-[#3b3b4f] w-full h-50 gap-3 items-center justify-center p-4">
        <div className="bg-white border-6 border-[#1b1b32]">
          <img 
        ...
        <div className="flex flex-col gap-5 p-3 bg-[#1b1b32] h-36 w-56">
          <div className="h-20">
            <p className="m-0 text-lg text-[#dfdfe2]">{currentSong.title}</p>
            <p className="m-0 text-xs text-[#f1be32]">{currentSong.artist}</p>
          </div>
          
          <div className="flex justify-around">
            <button 
              className="bg-transparent border-none text-[#dfdfe2] cursor-pointer" 
              aria-label="Previous"
              onClick={onPrevious}
            >
              <svg width="24" height="19" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M23.2248 0L7.03964 9.5L23.2248 19L23.2248 0Z" fill="currentColor" />
                <rect width="4.63633" height="18.5453" transform="matrix(-1 0 0 1 4.63633 0)" fill="currentColor" />
              </svg>
            </button>
            ...
            {!isPlaying ? (
              ...
              >
                <svg width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0 0L16.1852 9.5L1.88952e-07 19L0 0Z" fill="currentColor" />
                </svg>
              </button>
            ) : (
              <button 
                className="bg-transparent border-none text-[#f1be32] cursor-pointer" 
                aria-label="Pause"
                onClick={onPause}
              >
                <svg width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0 6.54013e-07H4.75V19H0V6.54013e-07Z" fill="currentColor" />
                  <path d="M11.4 0H16.15V19H11.4V0Z" fill="currentColor" />
                </svg>
              </button>
            )}
